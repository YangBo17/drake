  ...
  <model name='simple_test'>
    ...
    <joint name='J1' type='revolute'>
      ...
      <axis>
        ...
        <limit>
<<<<<<<< HEAD:tools/workspace/sdformat_internal/test/gz_sdf_test.py
          <lower>-inf</lower>
          <upper>inf</upper>
========
          <lower>-10000000000000000</lower>
          <upper>10000000000000000</upper>
>>>>>>>> 39291320815eca6c872c9ce0a595d643d0acf87c:tools/workspace/sdformat_internal/test/ign_sdf_test.py
        </limit>
      </axis>
    </joint>
    <link name='L2'>
